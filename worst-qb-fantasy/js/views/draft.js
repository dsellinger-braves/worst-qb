...
export const DraftView = {
    ...
    init: async () => {
        ...
        // Fetch players (Mocking some if DB is empty for demo purposes)
        ...
        if (players && players.length > 0) {
            qbList.innerHTML = players.map(p => `
                <div style="display: flex; justify-content: space-between; padding: 0.5rem; background: var(--glass-bg); border-radius: 4px;">
